...
def process_voucher_eligibility(
    ...
    def evaluate_sku_for_voucher(row, keywords, vc_pct):
        ...
        Filter order:
          ...
          1. Launch Date         — valid DD-MM-YYYY date <= cutoff date
          2. Ecom Status         — must be exactly YES
          3. RRP                 — must be > 16
          4. SRP                 — blank/0 is allowed; 1–16 inclusive is excluded.
        ...
        # Filter 4: SRP — blank/0 is allowed; 1–16 inclusive is excluded.
        # A blank SRP means no sale price (treated as 0 = allowed).
